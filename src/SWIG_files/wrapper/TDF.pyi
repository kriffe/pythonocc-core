...
class TDF_ComparisonTool:
	...
	@staticmethod
	def SourceUnbound(aRefDataSet: TDF_DataSet, aRelocationTable: TDF_RelocationTable, aFilter: TDF_IDFilter, aDiffDataSet: TDF_DataSet, anOption: Optional[int]) -> bool: ...
	@staticmethod
	def TargetUnbound(aRefDataSet: TDF_DataSet, aRelocationTable: TDF_RelocationTable, aFilter: TDF_IDFilter, aDiffDataSet: TDF_DataSet, anOption: Optional[int]) -> bool: ...
...
class TDF_Tool:
	...
	@overload
	@staticmethod
	def Label(aDF: TDF_Data, anEntry: TCollection_AsciiString, aLabel: TDF_Label, create: Optional[bool]) -> None: ...
	@overload
	@staticmethod
	def Label(aDF: TDF_Data, anEntry: str, aLabel: TDF_Label, create: Optional[bool]) -> None: ...
	@overload
	@staticmethod
	def Label(aDF: TDF_Data, aTagList: TColStd_ListOfInteger, aLabel: TDF_Label, create: Optional[bool]) -> None: ...
	@overload
	@staticmethod
	...
	@staticmethod
	def RelocateLabel(aSourceLabel: TDF_Label, fromRoot: TDF_Label, toRoot: TDF_Label, aTargetLabel: TDF_Label, create: Optional[bool]) -> None: ...
	@overload
	@staticmethod
