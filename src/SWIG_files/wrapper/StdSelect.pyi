...
class StdSelect_BRepSelectionTool:
	@staticmethod
	def ComputeSensitive(theShape: TopoDS_Shape, theOwner: SelectMgr_EntityOwner, theSelection: SelectMgr_Selection, theDeflection: float, theDeflAngle: float, theNbPOnEdge: int, theMaxiParam: float, theAutoTriang: Optional[bool]) -> None: ...
	@staticmethod
	...
	@staticmethod
	def GetSensitiveForFace(theFace: TopoDS_Face, theOwner: SelectMgr_EntityOwner, theOutList: Select3D_EntitySequence, theAutoTriang: Optional[bool], theNbPOnEdge: Optional[int], theMaxiParam: Optional[float], theInteriorFlag: Optional[bool]) -> bool: ...
	@staticmethod
	def GetStandardPriority(theShape: TopoDS_Shape, theType: TopAbs_ShapeEnum) -> int: ...
	@overload
	@staticmethod
	def Load(aSelection: SelectMgr_Selection, aShape: TopoDS_Shape, aType: TopAbs_ShapeEnum, theDeflection: float, theDeviationAngle: float, AutoTriangulation: Optional[bool], aPriority: Optional[int], NbPOnEdge: Optional[int], MaximalParameter: Optional[float]) -> None: ...
	@overload
	@staticmethod
	def Load(aSelection: SelectMgr_Selection, Origin: SelectMgr_SelectableObject, aShape: TopoDS_Shape, aType: TopAbs_ShapeEnum, theDeflection: float, theDeviationAngle: float, AutoTriangulation: Optional[bool], aPriority: Optional[int], NbPOnEdge: Optional[int], MaximalParameter: Optional[float]) -> None: ...
	@staticmethod
