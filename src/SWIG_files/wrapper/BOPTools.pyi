...
class BOPTools_AlgoTools:
	...
	@staticmethod
	def CorrectCurveOnSurface(theS: TopoDS_Shape, theMapToAvoid: TopTools_IndexedMapOfShape, theTolMax: Optional[float], theRunParallel: Optional[bool]) -> None: ...
	@staticmethod
	def CorrectPointOnCurve(theS: TopoDS_Shape, theMapToAvoid: TopTools_IndexedMapOfShape, theTolMax: Optional[float], theRunParallel: Optional[bool]) -> None: ...
	@overload
	@staticmethod
	...
	@staticmethod
	def CorrectShapeTolerances(theS: TopoDS_Shape, theMapToAvoid: TopTools_IndexedMapOfShape, theRunParallel: Optional[bool]) -> None: ...
	@staticmethod
	def CorrectTolerances(theS: TopoDS_Shape, theMapToAvoid: TopTools_IndexedMapOfShape, theTolMax: Optional[float], theRunParallel: Optional[bool]) -> None: ...
	@staticmethod
	...
	@staticmethod
	def IsMicroEdge(theEdge: TopoDS_Edge, theContext: IntTools_Context, theCheckSplittable: Optional[bool]) -> bool: ...
	@staticmethod
	def IsOpenShell(theShell: TopoDS_Shell) -> bool: ...
	@overload
	@staticmethod
	def IsSplitToReverse(theSplit: TopoDS_Shape, theShape: TopoDS_Shape, theContext: IntTools_Context, theError: Optional[int]) -> bool: ...
	@overload
	@staticmethod
	def IsSplitToReverse(theSplit: TopoDS_Face, theShape: TopoDS_Face, theContext: IntTools_Context, theError: Optional[int]) -> bool: ...
	@overload
	@staticmethod
	def IsSplitToReverse(theSplit: TopoDS_Edge, theShape: TopoDS_Edge, theContext: IntTools_Context, theError: Optional[int]) -> bool: ...
	@staticmethod
	def IsSplitToReverseWithWarn(theSplit: TopoDS_Shape, theShape: TopoDS_Shape, theContext: IntTools_Context, theReport: Optional[Message_Report]) -> bool: ...
	@staticmethod
	...
	@staticmethod
	def MakePCurve(theE: TopoDS_Edge, theF1: TopoDS_Face, theF2: TopoDS_Face, theCurve: IntTools_Curve, thePC1: bool, thePC2: bool, theContext: Optional[IntTools_Context]) -> None: ...
	@staticmethod
...
class BOPTools_AlgoTools2D:
	@overload
	@staticmethod
	def AdjustPCurveOnFace(theF: TopoDS_Face, theC3D: Geom_Curve, theC2D: Geom2d_Curve, theC2DA: Geom2d_Curve, theContext: Optional[IntTools_Context]) -> None: ...
	@overload
	@staticmethod
	def AdjustPCurveOnFace(theF: TopoDS_Face, theFirst: float, theLast: float, theC2D: Geom2d_Curve, theC2DA: Geom2d_Curve, theContext: Optional[IntTools_Context]) -> None: ...
	@staticmethod
	...
	@staticmethod
	def BuildPCurveForEdgeOnFace(aE: TopoDS_Edge, aF: TopoDS_Face, theContext: Optional[IntTools_Context]) -> None: ...
	@overload
	@staticmethod
	def CurveOnSurface(aE: TopoDS_Edge, aF: TopoDS_Face, aC: Geom2d_Curve, theContext: Optional[IntTools_Context]) -> float: ...
	@overload
	@staticmethod
	def CurveOnSurface(aE: TopoDS_Edge, aF: TopoDS_Face, aC: Geom2d_Curve, theContext: Optional[IntTools_Context]) -> Tuple[float, float, float]: ...
	@staticmethod
	...
	@staticmethod
	def Make2D(aE: TopoDS_Edge, aF: TopoDS_Face, aC: Geom2d_Curve, theContext: Optional[IntTools_Context]) -> Tuple[float, float, float]: ...
	@overload
	@staticmethod
	def MakePCurveOnFace(aF: TopoDS_Face, C3D: Geom_Curve, aC: Geom2d_Curve, theContext: Optional[IntTools_Context]) -> float: ...
	@overload
	@staticmethod
	def MakePCurveOnFace(aF: TopoDS_Face, C3D: Geom_Curve, aT1: float, aT2: float, aC: Geom2d_Curve, theContext: Optional[IntTools_Context]) -> float: ...
	@staticmethod
	def PointOnSurface(aE: TopoDS_Edge, aF: TopoDS_Face, aT: float, theContext: Optional[IntTools_Context]) -> Tuple[float, float]: ...
...
class BOPTools_AlgoTools3D:
	...
	@overload
	@staticmethod
	def GetNormalToFaceOnEdge(aE: TopoDS_Edge, aF: TopoDS_Face, aT: float, aD: gp_Dir, theContext: Optional[IntTools_Context]) -> None: ...
	@overload
	@staticmethod
	def GetNormalToFaceOnEdge(aE: TopoDS_Edge, aF: TopoDS_Face, aD: gp_Dir, theContext: Optional[IntTools_Context]) -> None: ...
	@staticmethod
	...
	@overload
	@staticmethod
	def PointInFace(theF: TopoDS_Face, theL: Geom2d_Curve, theP: gp_Pnt, theP2D: gp_Pnt2d, theContext: IntTools_Context, theDt2D: Optional[float]) -> int: ...
	@overload
	@staticmethod
