...
class IGESData_GlobalSection:
	...
	@overload
	@staticmethod
	def NewDateString(year: int, month: int, day: int, hour: int, minut: int, second: int, mode: Optional[int]) -> TCollection_HAsciiString: ...
	@overload
	@staticmethod
	def NewDateString(date: TCollection_HAsciiString, mode: Optional[int]) -> TCollection_HAsciiString: ...
...
class IGESData_ToolLocation(Standard_Transient):
	...
	@staticmethod
	def ConvertLocation(prec: float, loc: gp_GTrsf, result: gp_Trsf, uni: Optional[float]) -> bool: ...
...
class IGESData_HArray1OfIGESEntity(IGESData_Array1OfIGESEntity, Standard_Transient):
    def IGESData_HArray1OfIGESEntity(self, theLower: int, theUpper: int) -> None: ...
