...
class TopOpeBRepTool_CurveTool:
	...
	@staticmethod
	def MakePCurveOnFace(S: TopoDS_Shape, C: Geom_Curve, first: Optional[float], last: Optional[float]) -> Tuple[Geom2d_Curve, float]: ...
...
class TopOpeBRepTool_TOOL:
	...
	@staticmethod
	def OriinSor(sub: TopoDS_Shape, S: TopoDS_Shape, checkclo: Optional[bool]) -> int: ...
	@staticmethod
