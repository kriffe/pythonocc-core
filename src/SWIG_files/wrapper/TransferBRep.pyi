...
class transferbrep:
	...
	@staticmethod
	def Checked(chl: Interface_CheckIterator, alsoshapes: Optional[bool]) -> TColStd_HSequenceOfTransient: ...
	@staticmethod
	def CheckedShapes(chl: Interface_CheckIterator) -> TopTools_HSequenceOfShape: ...
	@staticmethod
	def PrintResultInfo(Printer: Message_Printer, Header: Message_Msg, ResultInfo: TransferBRep_TransferResultInfo, printEmpty: Optional[bool]) -> None: ...
	@staticmethod
	...
	@overload
	@staticmethod
	def Shapes(TP: Transfer_TransientProcess, rootsonly: Optional[bool]) -> TopTools_HSequenceOfShape: ...
	@overload
	@staticmethod
