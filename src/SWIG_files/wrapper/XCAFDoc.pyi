...
class XCAFDoc_Color(TDF_Attribute):
	...
	@overload
	@staticmethod
	def Set(label: TDF_Label, R: float, G: float, B: float, alpha: Optional[float]) -> XCAFDoc_Color: ...
	@overload
...
class XCAFDoc_DocumentTool(TDF_Attribute):
	...
	def Restore(self, with_: TDF_Attribute) -> None: ...
	@staticmethod
	def Set(L: TDF_Label, IsAcces: Optional[bool]) -> XCAFDoc_DocumentTool: ...
	@staticmethod
...
class XCAFDoc_Editor:
	@overload
	@staticmethod
	def Expand(Doc: TDF_Label, Shape: TDF_Label, recursively: Optional[bool]) -> bool: ...
	@overload
	@staticmethod
	def Expand(Doc: TDF_Label, recursively: Optional[bool]) -> bool: ...
...
class XCAFDoc_ShapeTool(TDF_Attribute):
	...
	@staticmethod
	def GetComponents(L: TDF_Label, Labels: TDF_LabelSequence, getsubchilds: Optional[bool]) -> bool: ...
	@staticmethod
	...
	@staticmethod
	def GetUsers(L: TDF_Label, Labels: TDF_LabelSequence, getsubchilds: Optional[bool]) -> int: ...
	def ID(self) -> Standard_GUID: ...
	def Init(self) -> None: ...
	@staticmethod
	...
	@staticmethod
	def NbComponents(L: TDF_Label, getsubchilds: Optional[bool]) -> int: ...
	def NewEmpty(self) -> TDF_Attribute: ...
