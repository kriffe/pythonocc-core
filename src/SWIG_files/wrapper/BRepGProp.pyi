...
class brepgprop:
	@staticmethod
	def LinearProperties(S: TopoDS_Shape, LProps: GProp_GProps, SkipShared: Optional[bool], UseTriangulation: Optional[bool]) -> None: ...
	@overload
	@staticmethod
	def SurfaceProperties(S: TopoDS_Shape, SProps: GProp_GProps, SkipShared: Optional[bool], UseTriangulation: Optional[bool]) -> None: ...
	@overload
	@staticmethod
	def SurfaceProperties(S: TopoDS_Shape, SProps: GProp_GProps, Eps: float, SkipShared: Optional[bool]) -> float: ...
	@overload
	@staticmethod
	def VolumeProperties(S: TopoDS_Shape, VProps: GProp_GProps, OnlyClosed: Optional[bool], SkipShared: Optional[bool], UseTriangulation: Optional[bool]) -> None: ...
	@overload
	@staticmethod
	def VolumeProperties(S: TopoDS_Shape, VProps: GProp_GProps, Eps: float, OnlyClosed: Optional[bool], SkipShared: Optional[bool]) -> float: ...
	@overload
	@staticmethod
	def VolumePropertiesGK(S: TopoDS_Shape, VProps: GProp_GProps, Eps: Optional[float], OnlyClosed: Optional[bool], IsUseSpan: Optional[bool], CGFlag: Optional[bool], IFlag: Optional[bool], SkipShared: Optional[bool]) -> float: ...
	@overload
	@staticmethod
	def VolumePropertiesGK(S: TopoDS_Shape, VProps: GProp_GProps, thePln: gp_Pln, Eps: Optional[float], OnlyClosed: Optional[bool], IsUseSpan: Optional[bool], CGFlag: Optional[bool], IFlag: Optional[bool], SkipShared: Optional[bool]) -> float: ...
