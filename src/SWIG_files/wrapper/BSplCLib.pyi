...
class bsplclib:
	...
	@staticmethod
	def EvalBsplineBasis(DerivativeOrder: int, Order: int, FlatKnots: TColStd_Array1OfReal, Parameter: float, BsplineBasis: math_Matrix, isPeriodic: Optional[bool]) -> Tuple[int, int]: ...
	@staticmethod
	...
	@overload
	@staticmethod
	def InsertKnots(Degree: int, Periodic: bool, Dimension: int, Poles: TColStd_Array1OfReal, Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger, AddKnots: TColStd_Array1OfReal, AddMults: TColStd_Array1OfInteger, NewPoles: TColStd_Array1OfReal, NewKnots: TColStd_Array1OfReal, NewMults: TColStd_Array1OfInteger, Epsilon: float, Add: Optional[bool]) -> None: ...
	@overload
	@staticmethod
	def InsertKnots(Degree: int, Periodic: bool, Poles: TColgp_Array1OfPnt, Weights: TColStd_Array1OfReal, Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger, AddKnots: TColStd_Array1OfReal, AddMults: TColStd_Array1OfInteger, NewPoles: TColgp_Array1OfPnt, NewWeights: TColStd_Array1OfReal, NewKnots: TColStd_Array1OfReal, NewMults: TColStd_Array1OfInteger, Epsilon: float, Add: Optional[bool]) -> None: ...
	@overload
	@staticmethod
	def InsertKnots(Degree: int, Periodic: bool, Poles: TColgp_Array1OfPnt2d, Weights: TColStd_Array1OfReal, Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger, AddKnots: TColStd_Array1OfReal, AddMults: TColStd_Array1OfInteger, NewPoles: TColgp_Array1OfPnt2d, NewWeights: TColStd_Array1OfReal, NewKnots: TColStd_Array1OfReal, NewMults: TColStd_Array1OfInteger, Epsilon: float, Add: Optional[bool]) -> None: ...
	@overload
	@staticmethod
	...
	@staticmethod
	def IsRational(Weights: TColStd_Array1OfReal, I1: int, I2: int, Epsilon: Optional[float]) -> bool: ...
	@staticmethod
	...
	@overload
	@staticmethod
	def KnotSequence(Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger, KnotSeq: TColStd_Array1OfReal, Periodic: Optional[bool]) -> None: ...
	@overload
	@staticmethod
	...
	@staticmethod
	def Knots(KnotSeq: TColStd_Array1OfReal, Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger, Periodic: Optional[bool]) -> None: ...
	@staticmethod
	def KnotsLength(KnotSeq: TColStd_Array1OfReal, Periodic: Optional[bool]) -> int: ...
	@staticmethod
	...
	@staticmethod
	def PrepareInsertKnots(Degree: int, Periodic: bool, Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger, AddKnots: TColStd_Array1OfReal, AddMults: TColStd_Array1OfInteger, Epsilon: float, Add: Optional[bool]) -> Tuple[bool, int, int]: ...
	@staticmethod
