...
class shapefix:
	@staticmethod
	def EncodeRegularity(shape: TopoDS_Shape, tolang: Optional[float]) -> None: ...
	@staticmethod
	...
	@staticmethod
	def SameParameter(shape: TopoDS_Shape, enforce: bool, preci: Optional[float], theProgress: Optional[Message_ProgressIndicator], theMsgReg: Optional[ShapeExtend_BasicMsgRegistrator]) -> bool: ...
