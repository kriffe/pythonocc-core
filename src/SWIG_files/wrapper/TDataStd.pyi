...
class TDataStd_ByteArray(TDF_Attribute):
	...
	@overload
	@staticmethod
	def Set(label: TDF_Label, lower: int, upper: int, isDelta: Optional[bool]) -> TDataStd_ByteArray: ...
	@overload
	@staticmethod
	def Set(label: TDF_Label, theGuid: Standard_GUID, lower: int, upper: int, isDelta: Optional[bool]) -> TDataStd_ByteArray: ...
...
class TDataStd_ExtStringArray(TDF_Attribute):
	...
	@overload
	@staticmethod
	def Set(label: TDF_Label, lower: int, upper: int, isDelta: Optional[bool]) -> TDataStd_ExtStringArray: ...
	@overload
	@staticmethod
	def Set(label: TDF_Label, theGuid: Standard_GUID, lower: int, upper: int, isDelta: Optional[bool]) -> TDataStd_ExtStringArray: ...
	def SetDelta(self, isDelta: bool) -> None: ...
	@overload
	def SetID(self, theGuid: Standard_GUID) -> None: ...
	@overload
...
class TDataStd_IntPackedMap(TDF_Attribute):
	...
	def Restore(self, with_: TDF_Attribute) -> None: ...
	@staticmethod
	def Set(label: TDF_Label, isDelta: Optional[bool]) -> TDataStd_IntPackedMap: ...
	def SetDelta(self, isDelta: bool) -> None: ...
...
class TDataStd_IntegerArray(TDF_Attribute):
	...
	@overload
	@staticmethod
	def Set(label: TDF_Label, lower: int, upper: int, isDelta: Optional[bool]) -> TDataStd_IntegerArray: ...
	@overload
	@staticmethod
	def Set(label: TDF_Label, theGuid: Standard_GUID, lower: int, upper: int, isDelta: Optional[bool]) -> TDataStd_IntegerArray: ...
	def SetDelta(self, isDelta: bool) -> None: ...
	@overload
	def SetID(self, theGuid: Standard_GUID) -> None: ...
	@overload
...
class TDataStd_RealArray(TDF_Attribute):
	...
	@overload
	@staticmethod
	def Set(label: TDF_Label, lower: int, upper: int, isDelta: Optional[bool]) -> TDataStd_RealArray: ...
	@overload
	@staticmethod
	def Set(label: TDF_Label, theGuid: Standard_GUID, lower: int, upper: int, isDelta: Optional[bool]) -> TDataStd_RealArray: ...
	def SetDelta(self, isDelta: bool) -> None: ...
	@overload
	def SetID(self, theGuid: Standard_GUID) -> None: ...
	@overload
...
class TDataStd_HLabelArray1(TDataStd_LabelArray1, Standard_Transient):
    def TDataStd_HLabelArray1(self, theLower: int, theUpper: int) -> None: ...
