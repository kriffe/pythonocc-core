...
class tnaming:
	...
	@staticmethod
	def Displace(label: TDF_Label, aLocation: TopLoc_Location, WithOld: Optional[bool]) -> None: ...
	@staticmethod
...
class TNaming_Naming(TDF_Attribute):
	...
	@staticmethod
	def Name(where: TDF_Label, Selection: TopoDS_Shape, Context: TopoDS_Shape, Geometry: Optional[bool], KeepOrientation: Optional[bool], BNproblem: Optional[bool]) -> TNaming_NamedShape: ...
	def NewEmpty(self) -> TDF_Attribute: ...
...
class TNaming_Selector:
	...
	@staticmethod
	def IsIdentified(access: TDF_Label, selection: TopoDS_Shape, NS: TNaming_NamedShape, Geometry: Optional[bool]) -> bool: ...
	def NamedShape(self) -> TNaming_NamedShape: ...
	@overload
...
class TNaming_Tool:
	@staticmethod
	def Collect(NS: TNaming_NamedShape, Labels: TNaming_MapOfNamedShape, OnlyModif: Optional[bool]) -> None: ...
	@overload
	@staticmethod
