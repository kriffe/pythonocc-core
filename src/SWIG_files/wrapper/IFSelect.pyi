...
class IFSelect_Activator(Standard_Transient):
	...
	@staticmethod
	def Commands(mode: Optional[int], command: Optional[str]) -> TColStd_HSequenceOfAsciiString: ...
...
class IFSelect_Functions:
	@staticmethod
	def GiveDispatch(WS: IFSelect_WorkSession, name: str, mode: Optional[bool]) -> IFSelect_Dispatch: ...
	@staticmethod
