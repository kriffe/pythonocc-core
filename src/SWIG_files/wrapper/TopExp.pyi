...
class topexp:
	...
	@staticmethod
	def FirstVertex(E: TopoDS_Edge, CumOri: Optional[bool]) -> TopoDS_Vertex: ...
	@staticmethod
	def LastVertex(E: TopoDS_Edge, CumOri: Optional[bool]) -> TopoDS_Vertex: ...
	@overload
	@staticmethod
	...
	@staticmethod
	def MapShapesAndUniqueAncestors(S: TopoDS_Shape, TS: TopAbs_ShapeEnum, TA: TopAbs_ShapeEnum, M: TopTools_IndexedDataMapOfShapeListOfShape, useOrientation: Optional[bool]) -> None: ...
	@overload
	@staticmethod
	def Vertices(E: TopoDS_Edge, Vfirst: TopoDS_Vertex, Vlast: TopoDS_Vertex, CumOri: Optional[bool]) -> None: ...
	@overload
	@staticmethod
