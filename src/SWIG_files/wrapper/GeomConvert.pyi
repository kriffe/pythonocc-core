...
class geomconvert:
	...
	@staticmethod
	def C0BSplineToC1BSplineCurve(BS: Geom_BSplineCurve, tolerance: float, AngularTolerance: Optional[float]) -> None: ...
	@overload
	@staticmethod
	...
	@staticmethod
	def CurveToBSplineCurve(C: Geom_Curve, Parameterisation: Optional[Convert_ParameterisationType]) -> Geom_BSplineCurve: ...
	@overload
	@staticmethod
	def SplitBSplineCurve(C: Geom_BSplineCurve, FromK1: int, ToK2: int, SameOrientation: Optional[bool]) -> Geom_BSplineCurve: ...
	@overload
	@staticmethod
	def SplitBSplineCurve(C: Geom_BSplineCurve, FromU1: float, ToU2: float, ParametricTolerance: float, SameOrientation: Optional[bool]) -> Geom_BSplineCurve: ...
	@overload
	@staticmethod
	def SplitBSplineSurface(S: Geom_BSplineSurface, FromUK1: int, ToUK2: int, FromVK1: int, ToVK2: int, SameUOrientation: Optional[bool], SameVOrientation: Optional[bool]) -> Geom_BSplineSurface: ...
	@overload
	@staticmethod
	def SplitBSplineSurface(S: Geom_BSplineSurface, FromK1: int, ToK2: int, USplit: bool, SameOrientation: Optional[bool]) -> Geom_BSplineSurface: ...
	@overload
	@staticmethod
	def SplitBSplineSurface(S: Geom_BSplineSurface, FromU1: float, ToU2: float, FromV1: float, ToV2: float, ParametricTolerance: float, SameUOrientation: Optional[bool], SameVOrientation: Optional[bool]) -> Geom_BSplineSurface: ...
	@overload
	@staticmethod
	def SplitBSplineSurface(S: Geom_BSplineSurface, FromParam1: float, ToParam2: float, USplit: bool, ParametricTolerance: float, SameOrientation: Optional[bool]) -> Geom_BSplineSurface: ...
	@staticmethod
