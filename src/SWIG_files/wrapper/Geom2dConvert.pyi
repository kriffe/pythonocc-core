...
class geom2dconvert:
	...
	@staticmethod
	def CurveToBSplineCurve(C: Geom2d_Curve, Parameterisation: Optional[Convert_ParameterisationType]) -> Geom2d_BSplineCurve: ...
	@overload
	@staticmethod
	def SplitBSplineCurve(C: Geom2d_BSplineCurve, FromK1: int, ToK2: int, SameOrientation: Optional[bool]) -> Geom2d_BSplineCurve: ...
	@overload
	@staticmethod
	def SplitBSplineCurve(C: Geom2d_BSplineCurve, FromU1: float, ToU2: float, ParametricTolerance: float, SameOrientation: Optional[bool]) -> Geom2d_BSplineCurve: ...
