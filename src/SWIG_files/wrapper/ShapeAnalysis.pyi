...
class ShapeAnalysis_Curve:
	...
	@staticmethod
	def IsClosed(curve: Geom_Curve, preci: Optional[float]) -> bool: ...
	@overload
	@staticmethod
	...
	@overload
	@staticmethod
	def IsPlanar(pnts: TColgp_Array1OfPnt, Normal: gp_XYZ, preci: Optional[float]) -> bool: ...
	@overload
	@staticmethod
	def IsPlanar(curve: Geom_Curve, Normal: gp_XYZ, preci: Optional[float]) -> bool: ...
	@overload
