...
class MeshVS_Tool:
	@overload
	@staticmethod
	def CreateAspectFillArea3d(theDr: MeshVS_Drawer, UseDefaults: Optional[bool]) -> Graphic3d_AspectFillArea3d: ...
	@overload
	@staticmethod
	def CreateAspectFillArea3d(theDr: MeshVS_Drawer, Mat: Graphic3d_MaterialAspect, UseDefaults: Optional[bool]) -> Graphic3d_AspectFillArea3d: ...
	@staticmethod
	def CreateAspectLine3d(theDr: MeshVS_Drawer, UseDefaults: Optional[bool]) -> Graphic3d_AspectLine3d: ...
	@staticmethod
	def CreateAspectMarker3d(theDr: MeshVS_Drawer, UseDefaults: Optional[bool]) -> Graphic3d_AspectMarker3d: ...
	@staticmethod
	def CreateAspectText3d(theDr: MeshVS_Drawer, UseDefaults: Optional[bool]) -> Graphic3d_AspectText3d: ...
	@staticmethod
...
class MeshVS_HArray1OfSequenceOfInteger(MeshVS_Array1OfSequenceOfInteger, Standard_Transient):
    def MeshVS_HArray1OfSequenceOfInteger(self, theLower: int, theUpper: int) -> None: ...
