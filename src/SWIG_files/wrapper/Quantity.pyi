...
class Quantity_Date:
	...
	@staticmethod
	def IsValid(mm: int, dd: int, yy: int, hh: int, mn: int, ss: int, mis: Optional[int], mics: Optional[int]) -> bool: ...
...
class Quantity_Period:
	...
	@overload
	@staticmethod
	def IsValid(dd: int, hh: int, mn: int, ss: int, mis: Optional[int], mics: Optional[int]) -> bool: ...
	@overload
	@staticmethod
	def IsValid(ss: int, mics: Optional[int]) -> bool: ...
	@overload
...
class Quantity_HArray1OfColor(Quantity_Array1OfColor, Standard_Transient):
    def Quantity_HArray1OfColor(self, theLower: int, theUpper: int) -> None: ...
