...
class breptools:
	...
	@overload
	@staticmethod
	def Read(Sh: TopoDS_Shape, File: str, B: BRep_Builder, PR: Optional[Message_ProgressIndicator]) -> bool: ...
	@staticmethod
	...
	@overload
	@staticmethod
	def Write(Sh: TopoDS_Shape, File: str, PR: Optional[Message_ProgressIndicator]) -> bool: ...
