...
class breplib:
	@staticmethod
	def BuildCurve3d(E: TopoDS_Edge, Tolerance: Optional[float], Continuity: Optional[GeomAbs_Shape], MaxDegree: Optional[int], MaxSegment: Optional[int]) -> bool: ...
	@overload
	@staticmethod
	def BuildCurves3d(S: TopoDS_Shape, Tolerance: float, Continuity: Optional[GeomAbs_Shape], MaxDegree: Optional[int], MaxSegment: Optional[int]) -> bool: ...
	@overload
	@staticmethod
	...
	@staticmethod
	def CheckSameRange(E: TopoDS_Edge, Confusion: Optional[float]) -> bool: ...
	@overload
	@staticmethod
	def EncodeRegularity(S: TopoDS_Shape, TolAng: Optional[float]) -> None: ...
	@overload
	@staticmethod
	def EncodeRegularity(S: TopoDS_Shape, LE: TopTools_ListOfShape, TolAng: Optional[float]) -> None: ...
	@overload
	@staticmethod
	def EncodeRegularity(E: TopoDS_Edge, F1: TopoDS_Face, F2: TopoDS_Face, TolAng: Optional[float]) -> None: ...
	@staticmethod
	def EnsureNormalConsistency(S: TopoDS_Shape, theAngTol: Optional[float], ForceComputeNormals: Optional[bool]) -> bool: ...
	@staticmethod
	...
	@overload
	@staticmethod
	def SameParameter(theEdge: TopoDS_Edge, Tolerance: Optional[float]) -> None: ...
	@overload
	@staticmethod
	def SameParameter(theEdge: TopoDS_Edge, theTolerance: float, IsUseOldEdge: bool) -> Tuple[TopoDS_Edge, float]: ...
	@overload
	@staticmethod
	def SameParameter(S: TopoDS_Shape, Tolerance: Optional[float], forced: Optional[bool]) -> None: ...
	@overload
	@staticmethod
	def SameParameter(S: TopoDS_Shape, theReshaper: BRepTools_ReShape, Tolerance: Optional[float], forced: Optional[bool]) -> None: ...
	@staticmethod
	def SameRange(E: TopoDS_Edge, Tolerance: Optional[float]) -> None: ...
	@staticmethod
	...
	@overload
	@staticmethod
	def UpdateTolerances(S: TopoDS_Shape, verifyFaceTolerance: Optional[bool]) -> None: ...
	@overload
	@staticmethod
	def UpdateTolerances(S: TopoDS_Shape, theReshaper: BRepTools_ReShape, verifyFaceTolerance: Optional[bool]) -> None: ...
