...
class BRepMesh_ShapeTool(Standard_Transient):
	...
	@overload
	@staticmethod
	def Range(theEdge: TopoDS_Edge, theFace: TopoDS_Face, thePCurve: Geom2d_Curve, isConsiderOrientation: Optional[bool]) -> Tuple[bool, float, float]: ...
	@overload
	@staticmethod
	def Range(theEdge: TopoDS_Edge, theCurve: Geom_Curve, isConsiderOrientation: Optional[bool]) -> Tuple[bool, float, float]: ...
	@staticmethod
	def UVPoints(theEdge: TopoDS_Edge, theFace: TopoDS_Face, theFirstPoint2d: gp_Pnt2d, theLastPoint2d: gp_Pnt2d, isConsiderOrientation: Optional[bool]) -> bool: ...
	@overload
	@staticmethod
