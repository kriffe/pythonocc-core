...
class ais:
	...
	@staticmethod
	def ComputeProjEdgePresentation(aPres: Prs3d_Presentation, aDrawer: Prs3d_Drawer, anEdge: TopoDS_Edge, ProjCurve: Geom_Curve, FirstP: gp_Pnt, LastP: gp_Pnt, aColor: Optional[Quantity_NameOfColor], aWidth: Optional[float], aProjTOL: Optional[Aspect_TypeOfLine], aCallTOL: Optional[Aspect_TypeOfLine]) -> None: ...
	@staticmethod
	def ComputeProjVertexPresentation(aPres: Prs3d_Presentation, aDrawer: Prs3d_Drawer, aVertex: TopoDS_Vertex, ProjPoint: gp_Pnt, aColor: Optional[Quantity_NameOfColor], aWidth: Optional[float], aProjTOM: Optional[Aspect_TypeOfMarker], aCallTOL: Optional[Aspect_TypeOfLine]) -> None: ...
	@staticmethod
	...
	@staticmethod
	def InitAngleBetweenCurvilinearFaces(theFirstFace: TopoDS_Face, theSecondFace: TopoDS_Face, theFirstSurfType: AIS_KindOfSurface, theSecondSurfType: AIS_KindOfSurface, theCenter: gp_Pnt, theFirstAttach: gp_Pnt, theSecondAttach: gp_Pnt, theIsFirstPointSet: Optional[bool]) -> bool: ...
	@staticmethod
	def InitAngleBetweenPlanarFaces(theFirstFace: TopoDS_Face, theSecondFace: TopoDS_Face, theCenter: gp_Pnt, theFirstAttach: gp_Pnt, theSecondAttach: gp_Pnt, theIsFirstPointSet: Optional[bool]) -> bool: ...
	@staticmethod
