...
class Interface_MSG:
	...
	def Destroy(self) -> None: ...
	@staticmethod
	def Intervalled(val: float, order: Optional[int], upper: Optional[bool]) -> float: ...
	@staticmethod
...
class Interface_STAT:
	...
	@staticmethod
	def NextItem(nbitems: Optional[int]) -> None: ...
	@staticmethod
	def NextPhase(items: int, cycles: Optional[int]) -> None: ...
	@staticmethod
	def NextStep() -> None: ...
	@staticmethod
	def Percent(phase: Optional[bool]) -> int: ...
	def Phase(self, num: int, name: str) -> Tuple[int, int, float]: ...
	@staticmethod
	def SetPhase(items: int, cycles: Optional[int]) -> None: ...
	...
	@staticmethod
	def Where(phase: Optional[bool]) -> str: ...
...
class Interface_Static(Interface_TypedValue):
	...
	@staticmethod
	def IsSet(name: str, proper: Optional[bool]) -> bool: ...
	@staticmethod
	def IsUpdated(name: str) -> bool: ...
	@staticmethod
	def Items(mode: Optional[int], criter: Optional[str]) -> TColStd_HSequenceOfHAsciiString: ...
...
class Interface_HArray1OfHAsciiString(Interface_Array1OfHAsciiString, Standard_Transient):
    def Interface_HArray1OfHAsciiString(self, theLower: int, theUpper: int) -> None: ...
