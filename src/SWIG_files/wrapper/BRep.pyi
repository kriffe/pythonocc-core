...
class BRep_Tool:
	...
	@overload
	@staticmethod
	def CurveOnSurface(E: TopoDS_Edge, F: TopoDS_Face, theIsStored: Optional[bool]) -> Tuple[Geom2d_Curve, float, float]: ...
	@overload
	@staticmethod
	def CurveOnSurface(E: TopoDS_Edge, S: Geom_Surface, L: TopLoc_Location, theIsStored: Optional[bool]) -> Tuple[Geom2d_Curve, float, float]: ...
	@overload
	@staticmethod
