...
class brepoffset:
	...
	@staticmethod
	def Surface(Surface: Geom_Surface, Offset: float, theStatus: BRepOffset_Status, allowC0: Optional[bool]) -> Geom_Surface: ...
...
class BRepOffset_Tool:
	...
	@staticmethod
	def CheckPlanesNormals(theFace1: TopoDS_Face, theFace2: TopoDS_Face, theTolAng: Optional[float]) -> bool: ...
	@staticmethod
	...
	@staticmethod
	def Inter3D(F1: TopoDS_Face, F2: TopoDS_Face, LInt1: TopTools_ListOfShape, LInt2: TopTools_ListOfShape, Side: TopAbs_State, RefEdge: TopoDS_Edge, IsRefEdgeDefined: Optional[bool]) -> None: ...
	@staticmethod
