...
class TopOpeBRepBuild_Tools:
	...
	@staticmethod
	def CorrectCurveOnSurface(aS: TopoDS_Shape, aTolMax: Optional[float]) -> None: ...
	@staticmethod
	...
	@staticmethod
	def CorrectPointOnCurve(aS: TopoDS_Shape, aTolMax: Optional[float]) -> None: ...
	@staticmethod
	def CorrectTolerances(aS: TopoDS_Shape, aTolMax: Optional[float]) -> None: ...
	@staticmethod
