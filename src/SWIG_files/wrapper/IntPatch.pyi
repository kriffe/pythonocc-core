...
class IntPatch_SpecialPoints:
	@staticmethod
	def AddCrossUVIsoPoint(theQSurf: Adaptor3d_HSurface, thePSurf: Adaptor3d_HSurface, theRefPt: IntSurf_PntOn2S, theTol3d: float, theAddedPoint: IntSurf_PntOn2S, theIsReversed: Optional[bool]) -> bool: ...
	@staticmethod
	def AddPointOnUorVIso(theQSurf: Adaptor3d_HSurface, thePSurf: Adaptor3d_HSurface, theRefPt: IntSurf_PntOn2S, theIsU: bool, theIsoParameter: float, theToler: math_Vector, theInitPoint: math_Vector, theInfBound: math_Vector, theSupBound: math_Vector, theAddedPoint: IntSurf_PntOn2S, theIsReversed: Optional[bool]) -> bool: ...
	@staticmethod
	def AddSingularPole(theQSurf: Adaptor3d_HSurface, thePSurf: Adaptor3d_HSurface, thePtIso: IntSurf_PntOn2S, theVertex: IntPatch_Point, theAddedPoint: IntSurf_PntOn2S, theIsReversed: Optional[bool], theIsReqRefCheck: Optional[bool]) -> bool: ...
	@staticmethod
	def AdjustPointAndVertex(theRefPoint: IntSurf_PntOn2S, theArrPeriods_list: List[float], theNewPoint: IntSurf_PntOn2S, theVertex: Optional[IntPatch_Point]) -> None: ...
	@staticmethod
	def ContinueAfterSpecialPoint(theQSurf: Adaptor3d_HSurface, thePSurf: Adaptor3d_HSurface, theRefPt: IntSurf_PntOn2S, theSPType: IntPatch_SpecPntType, theTol2D: float, theNewPoint: IntSurf_PntOn2S, theIsReversed: Optional[bool]) -> bool: ...
