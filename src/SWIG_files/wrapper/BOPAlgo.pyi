...
class BOPAlgo_Tools:
	@staticmethod
	def ClassifyFaces(theFaces: TopTools_ListOfShape, theSolids: TopTools_ListOfShape, theRunParallel: bool, theContext: IntTools_Context, theInParts: TopTools_IndexedDataMapOfShapeListOfShape, theShapeBoxMap: Optional[TopTools_DataMapOfShapeBox], theSolidsIF: Optional[TopTools_DataMapOfShapeListOfShape]) -> None: ...
	@staticmethod
	def ComputeToleranceOfCB(theCB: BOPDS_CommonBlock, theDS: BOPDS_PDS, theContext: IntTools_Context) -> float: ...
	@staticmethod
	def EdgesToWires(theEdges: TopoDS_Shape, theWires: TopoDS_Shape, theShared: Optional[bool], theAngTol: Optional[float]) -> int: ...
	@staticmethod
	...
	@overload
	@staticmethod
	def PerformCommonBlocks(theMBlocks: BOPDS_IndexedDataMapOfPaveBlockListOfPaveBlock, theAllocator: NCollection_BaseAllocator, theDS: BOPDS_PDS, theContext: Optional[IntTools_Context]) -> None: ...
	@overload
	@staticmethod
	def PerformCommonBlocks(theMBlocks: BOPDS_IndexedDataMapOfPaveBlockListOfInteger, theAllocator: NCollection_BaseAllocator, pDS: BOPDS_PDS, theContext: Optional[IntTools_Context]) -> None: ...
	@staticmethod
	def TreatCompound(theS: TopoDS_Shape, theMFence: TopTools_MapOfShape, theLS: TopTools_ListOfShape) -> None: ...
	@staticmethod
	def WiresToFaces(theWires: TopoDS_Shape, theFaces: TopoDS_Shape, theAngTol: Optional[float]) -> bool: ...
