...
class bsplslib:
	...
	@staticmethod
	def IsRational(Weights: TColStd_Array2OfReal, I1: int, I2: int, J1: int, J2: int, Epsilon: Optional[float]) -> bool: ...
	@staticmethod
	...
	@staticmethod
	def RationalDerivative(UDeg: int, VDeg: int, N: int, M: int, All: Optional[bool]) -> Tuple[float, float]: ...
	@staticmethod
