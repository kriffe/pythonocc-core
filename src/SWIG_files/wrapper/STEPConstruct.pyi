...
class STEPConstruct_Styles(STEPConstruct_Tool):
	...
	def MakeColorPSA(self, item: StepRepr_RepresentationItem, SurfCol: StepVisual_Colour, CurveCol: StepVisual_Colour, isForNAUO: Optional[bool] = False) -> StepVisual_PresentationStyleAssignment: ...
