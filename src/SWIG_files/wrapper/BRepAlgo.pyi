...
class brepalgo:
	@staticmethod
	def ConcatenateWire(Wire: TopoDS_Wire, Option: GeomAbs_Shape, AngularTolerance: Optional[float]) -> TopoDS_Wire: ...
	@staticmethod
	...
	@overload
	@staticmethod
	def IsValid(theArgs: TopTools_ListOfShape, theResult: TopoDS_Shape, closedSolid: Optional[bool], GeomCtrl: Optional[bool]) -> bool: ...
