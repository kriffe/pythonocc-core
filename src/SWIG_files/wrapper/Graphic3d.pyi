...
class Graphic3d_BSDF:
	...
	@staticmethod
	def CreateGlass(theWeight: Graphic3d_Vec3, theAbsorptionColor: Graphic3d_Vec3, theAbsorptionCoeff: Standard_ShortReal, theRefractionIndex: Standard_ShortReal) -> Graphic3d_BSDF: ...
	@staticmethod
	def CreateMetallic(theWeight: Graphic3d_Vec3, theFresnel: Graphic3d_Fresnel, theRoughness: Standard_ShortReal) -> Graphic3d_BSDF: ...
	@staticmethod
	def CreateTransparent(theWeight: Graphic3d_Vec3, theAbsorptionColor: Graphic3d_Vec3, theAbsorptionCoeff: Standard_ShortReal) -> Graphic3d_BSDF: ...
...
class Graphic3d_Fresnel:
	...
	@overload
	@staticmethod
	def CreateConductor(theRefractionIndex: Standard_ShortReal, theAbsorptionIndex: Standard_ShortReal) -> Graphic3d_Fresnel: ...
	@overload
	@staticmethod
	def CreateConductor(theRefractionIndex: Graphic3d_Vec3, theAbsorptionIndex: Graphic3d_Vec3) -> Graphic3d_Fresnel: ...
	@staticmethod
	def CreateConstant(theReflection: Standard_ShortReal) -> Graphic3d_Fresnel: ...
	@staticmethod
	def CreateDielectric(theRefractionIndex: Standard_ShortReal) -> Graphic3d_Fresnel: ...
	@staticmethod
